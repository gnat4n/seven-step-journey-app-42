...
const StepExercisesPage = () => {
  ...
  const allExercisesCompleted = completedExercises.length === 3; // For step 1, we have 3 exercises
  ...
  // Only show exercises for step 1
  if (Number(stepId) !== 1) {
    navigate(`/passo/${stepId}`);
    return null;
  }
      ...
      <div className="container py-8 flex-1">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-brand-600 to-brand-800 bg-clip-text text-transparent">
            Exercícios Práticos: Desintoxicação Mental
          </h1>
